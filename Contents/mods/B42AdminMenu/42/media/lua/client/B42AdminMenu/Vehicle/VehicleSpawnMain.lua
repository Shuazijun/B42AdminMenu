require "B42AdminMenu/Vehicle/VehicleSpawnList"
require "B42AdminMenu/Vehicle/VehicleSpawnDeploy"

--VehicleSpawnText = ISPanel:derive("VehicleSpawnText")
--VehicleSpawnContext = ISUIElement:derive("VehicleSpawnContext")

---@class CategoryButton : ISButton
---@field cat string
---@field target VehicleSpawnUI

---@class SearchIcon : ISImage
---@field scaledWidth number
---@field scaledHeight number

---@class VehicleSpawnUI : ISCollapsableWindow
---@field public catPanel VehicleSpawnList
---@field public srchBar ISTextEntryBox
---@field public srchIcon ISImage
---@field public contPanel VehicleSpawnList
---@field public btmPanel ISPanel
---@field public btmBar ISPanel
---@field public curCat string
---@field public srchString string|nil
...
function VehicleSpawnUI:createChildren()
	...
	---@cast getTexture fun(path: string): any
	local texture = getTexture("media/UI/crucibleUI/search.png")
	if texture then
		---@type SearchIcon
		self.srchIcon = ISImage:new(self.srchBar.x,self.srchBar.y + 2, 0,0,texture)
