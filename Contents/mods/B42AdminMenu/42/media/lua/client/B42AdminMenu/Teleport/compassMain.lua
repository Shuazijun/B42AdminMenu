require "B42AdminMenu/Teleport/compassList"
require "B42AdminMenu/Teleport/compassPOI"
require "B42AdminMenu/Teleport/compassHoverMenu"

---@class compassCategoryButton : ISButton
---@field cat string
---@field target compassUI

---@class compassUI : ISCollapsableWindow
---@field catPanel compassList
---@field contPanel compassList
---@field btmPanel ISPanel
---@field srchBar ISTextEntryBox
---@field srchIcon ISImage
---@field newCustom ISButton
---@field btmBar ISPanel
---@field srchString string
---@field curCat string
