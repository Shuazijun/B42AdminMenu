CheatCoreCM.TerraformTiles = {
	...
	TileTypes = {
		...
		RedCarpet = {Category = getText("UI_CMRB_Terrain_Carpets"), Name = Translator.getMoveableDisplayName("Red_Carpet"), Ranges = {9}, Tileset = "floors_interior_carpet_01_"},
		BlueGreyCarpet = {Category = getText("UI_CMRB_Terrain_Carpets"), Name = Translator.getMoveableDisplayName("Dark_Grey_Carpet"), Ranges = {2}, Tileset = "floors_interior_carpet_01_"},
		MauveCarpet = {Category = getText("UI_CMRB_Terrain_Carpets"), Name = Translator.getMoveableDisplayName("Dark_Red_Carpet"), Ranges = {4}, Tileset = "floors_interior_carpet_01_"},
		MagentaCarpet = {Category = getText("UI_CMRB_Terrain_Carpets"), Name = Translator.getMoveableDisplayName("Violet_Carpet"), Ranges = {6}, Tileset = "floors_interior_carpet_01_"},
