---@class SkillInputWindow : ISCollapsableWindow
---@field IDs table
---@field InpBar ISTextEntryBox
---@field InpButton ISButton
---@field func fun(value: number|string, args: unknown)|nil
---@field args unknown
SkillInputWindow = ISCollapsableWindow:derive("SkillInputWindow")
...
---@param title string
---@param ID any
---@param onPress fun(value: number|string, args: unknown)|nil
---@param args unknown|nil
---@return SkillInputWindow
function SkillInputWindow:new(title, ID, onPress, args)
	...
	o.InpButton = ISButton:new(0, o.InpBar:getHeight() + o:titleBarHeight(), o:getWidth(), o:getHeight() / 2, getText("UI_CMRB_Window_Set"), o, function()
		if o.func then
			if o.InpBar:getText() == nil or o.InpBar:getText() == "" then
				o.func(0, o.args)
			else
				o.func(o.InpBar:getText(), o.args)
			end
