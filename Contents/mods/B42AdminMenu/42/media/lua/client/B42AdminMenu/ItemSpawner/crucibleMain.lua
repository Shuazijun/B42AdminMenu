---@class CrucibleCategoryButton : ISButton
---@field cat string
---@field target crucibleUI

---@class crucibleUI : ISCollapsableWindow
---@field srchString string|nil
---@field curCat string
---@field catPanel crucibleList
---@field btmPanel ISPanel
---@field srchBar ISTextEntryBox
---@field srchIcon ISImage
---@field sortBtn ISComboBox
---@field amountBtn ISComboBox
---@field contPanel crucibleList
...
function crucibleUI:createChildren()
	...
	self.curCat = firstCategory or "All"
