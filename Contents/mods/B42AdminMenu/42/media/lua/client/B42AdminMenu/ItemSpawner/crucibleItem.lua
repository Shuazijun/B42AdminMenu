---@class CrucibleItemImage : ISImage
---@field ph number
---@field pw number

---@class crucibleItem : ISUIElement
---@field made boolean
---@field panel ISPanel
---@field image CrucibleItemImage
...
function crucibleItem:addItem()
	...
	if self.debug == true then
		...
		print(self.item:getItemType():toString())
		print(self.item:getItemType():toString())
		...
		if test then
			...
			print("type", test:getItemType():toString())
...
function crucibleItem:new(x,y,width,height,item)
	...
	o.doFade = false
	--print(item:getItemType():toString())
	--print(item:getItemType():toString())
